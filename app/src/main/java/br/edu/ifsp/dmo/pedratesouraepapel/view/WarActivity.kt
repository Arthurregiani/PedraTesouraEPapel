...
class WarActivity : AppCompatActivity() {
    ...
    private var isBotPlayer2: Boolean = false
    ...
    private fun configListener() {
        ...
        binding.buttonWeapon2.setOnClickListener { if (!isBotPlayer2) startSelectionActivity(2) else selectBotWeapon() }
            ...
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                if (result.resultCode == Activity.RESULT_OK) {
                    ...
                    if (extras != null) {
                        ...
                        if (number == 1) weaponPlayer1 = chosenWeapon
                        if (number == 2) weaponPlayer2 = chosenWeapon
                    }
                }
            }
    }
    ...
    private fun openBundle() {
        ...
        if (extras != null) {
            ...
            isBotPlayer2 = extras.getBoolean(Constants.KEY_IS_BOT_PLAYER_2, false)
    ...
    private fun selectBotWeapon() {
        weaponPlayer2 = getRandomWeapon()
        binding.buttonWeapon2.text = "${war.opponent2.name} ${getString(R.string.weapon_selected)}"
    }
